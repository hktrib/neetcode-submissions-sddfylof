class Solution:
    def islandsAndTreasure(self, grid: List[List[int]]) -> None:
        ...
        def bfs():
            ...
            # We wrap the main logic in a while queue
            # this keeps our BFS algo running.

            # Also key point to remember is that we can't modify the queue and
            # also for loop through it. Python will raise an error.
